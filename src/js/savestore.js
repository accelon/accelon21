...
export const loadSettings=()=>{
    ...
    const factorization=parseInt(localStorage.getItem(AppPrefix+'factorization')||'0');
    ...
    return {tosim,palitrans,column,tab,toolbox_panepos,panepos,queryhistory,bookqueryhistory};
}

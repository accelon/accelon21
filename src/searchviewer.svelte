...
const refreshquery=async (_addr)=>{
    ...
    if (oldptk!==ptk) {
        ...
        // need to subscribe manually, cannot use $: syntax as filteredStore is dynamically generated by derived
        //use number to denote all entries without create an array of sequencial numbers,
